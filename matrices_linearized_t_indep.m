...
matrices.adim.ephase.elyte.logterm_BC = ...
            @(t,ELYTE2N) (matrices.adim.ephase.D2_noBC(2:end-1,2:end-1) * log(1 + ELYTE2N / params.adim.c_0)...
                                            ...
                                            + matrices.adim.ephase.D2_noBC(2:end-1,1) * log( 1 + (matrices.adim.ephase.elyte.Vmod(t) + matrices.adim.ephase.elyte.Emod * ELYTE2N)/params.adim.c_0)...
                                        );
...
matrices.adim.sphase.us.exogeneous_nonlinear = ...
            @(DLK,US2R) (matrices.adim.sphase.D2_noBC(2:end-1,1) ...
